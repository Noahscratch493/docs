...
description: "Embedding ScratchFrame is easy! You can embed profiles, studios, or explore pages anywhere using iframes. Just choose what you want to embed and add the proper query parameters."
---
